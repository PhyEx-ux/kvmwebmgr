...
mv -f  /home/kvm/ifcfg-br0 /etc/sysconfig/network-scripts/
rm -f  /etc/sysconfig/network-scripts/ifcfg-enp0s25
mv -f  /home/kvm/ifcfg-enp0s25 /etc/sysconfig/network-scripts/ifcfg-enp0s25
...
mv -f  /home/kvm/webvirtmgr.conf /etc/nginx/conf.d
yum -y install vim*
echo "zhushi server"
sleep 3s
...
mv -f  /home/kvm/webvirtmgr.conf /etc/supervisord.d/webvirtmgr.ini
sudo service supervisord stop
sudo service supervisord start
mv -f  /home/kvm/templates /var/www/
